...
class EmployeeDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_detail" do
    assert_difference('EmployeeDetail.count') do
      post employee_details_url, params: { employee_detail: { email: @employee_detail.email, experience: @employee_detail.experience, fName: @employee_detail.fName, lName: @employee_detail.lName, role: @employee_detail.role } }
    end
  ...
  test "should update employee_detail" do
    patch employee_detail_url(@employee_detail), params: { employee_detail: { email: @employee_detail.email, experience: @employee_detail.experience, fName: @employee_detail.fName, lName: @employee_detail.lName, role: @employee_detail.role } }
